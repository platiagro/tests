...
E(/removidos da lista de projetos/) { ->
  ...
  def projDeleteV = $(By.xpath("//*[@id='root']/section/section/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[2]/button/span[text()='"+nomeProjV+"']")).isDisplayed()
  assert projDeleteV == false
