  ...
  static at = {
   title == "PlatIAgro - Plataforma de Inteligência Artficial para o Agronegócio" }
    static content ={
     ...
     btnclear{$(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/div[2]/form/div[1]/div[2]/div/span/span/span/i/svg/path"))}
     ...
     btnedit {$(By.xpath("//*[@id='root']/section/section/div[1]/div/span/div/i/svg"))}
     nomedit {$(By.xpath("//*[@id='root']/section/section/div[1]/div/span"))}
